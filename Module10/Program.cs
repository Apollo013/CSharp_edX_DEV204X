    ...
    class Program
    {
        ...
        public class LinqSamples
        {
            ...
            public void Linq3()
            {
                ...
                var expensiveInStockProducts = products.Where((product) => product.UnitPrice > 3 && product.UnitsInStock > 0).OrderBy((product) => product.ProductName);
            ...
            public void Linq30()
            {
                ...
                var sortedProducts = from prod in products orderby prod.ProductName descending select prod;
            ...
            public void Linq32()
            {
                ...
                var sortedDoubles = doubles.OrderByDescending(num => num);
