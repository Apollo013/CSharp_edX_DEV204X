...
namespace Module08
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Add your three students to this Course object. (List<T>.Add method implemented in the 'Add(Student student)' method)
            course.Add(stud1);
            course.Add(stud2);
            course.Add(stud3);
    ...
    public class Student : Person
    {
        ...
        public Stack<Double> Grades { get; set; } = new Stack<Double>(); //***** Stack<Double> Grades
    ...
    public class Course
    {
        ...
        public List<Student> Students { get; set; } //***** List<Student> Students
        ...
        {
            Students.Add(student);  //***** List<T>.Add(object)
            return true;
        }
